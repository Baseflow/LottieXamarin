...
namespace Lottie.Forms.Platforms.Uap
{
    public class AnimationViewRenderer : ViewRenderer<AnimationView, AnimatedVisualPlayer>
    {
        ...
        private void _animationView_Tapped(object sender, Microsoft.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            Element?.InvokeClick();
        }

        private async void _animationView_Loaded(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
